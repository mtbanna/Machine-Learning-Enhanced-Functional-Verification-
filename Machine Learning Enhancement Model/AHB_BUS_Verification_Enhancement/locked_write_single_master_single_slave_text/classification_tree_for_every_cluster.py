...
training_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/training_data_after_cluster.csv',sep=',')
prediction_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/prediction_data_after_cluster.csv',sep=',')
...
prediction_result=pruned_classification_tree0.predict(x_prediction)
...
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/cluster0_predicted_data.csv', index=False)
...
prediction_result=pruned_classification_tree1.predict(x_prediction)
x_prediction['Coverage']=prediction_result
x_prediction.sort_values(by="Coverage",axis=0,inplace=True, ascending=False)
x_prediction.reset_index(drop=True,inplace=True)
x_prediction.drop(columns=["Coverage"],axis=1, inplace=True)
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/cluster1_predicted_data.csv', index=False)
...
prediction_result=pruned_classification_tree2.predict(x_prediction)
x_prediction['Coverage']=prediction_result
x_prediction.sort_values(by="Coverage",axis=0,inplace=True, ascending=False)
x_prediction.reset_index(drop=True,inplace=True)
x_prediction.drop(columns=["Coverage"],axis=1, inplace=True)
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/cluster2_predicted_data.csv', index=False)
...
prediction_result=pruned_classification_tree3.predict(x_prediction)
x_prediction['Coverage']=prediction_result
x_prediction.sort_values(by="Coverage",axis=0,inplace=True, ascending=False)
x_prediction.reset_index(drop=True,inplace=True)
x_prediction.drop(columns=["Coverage"],axis=1, inplace=True)
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/cluster3_predicted_data.csv', index=False)
