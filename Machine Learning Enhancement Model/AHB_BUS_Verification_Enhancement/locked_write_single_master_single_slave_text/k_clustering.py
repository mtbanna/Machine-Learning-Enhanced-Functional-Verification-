...
#%% Read Data
training_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/to_python/training/locked_write_single_master_single_slave.csv',sep=',')
...
for i in range(1,10):
    ...
    training_data_cluster=k_model.fit_predict(x[["M_HADDR","M_HWDATA"]])
...
prediction_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/to_python/prediction/locked_write_single_master_single_slave.csv',sep=',')
...
cluster_prediction=k_model.predict(x_prediction[["M_HADDR","M_HWDATA"]])
...
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/prediction_data_after_cluster.csv', index=False)
training_data_after_cluster.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/locked_write_single_master_single_slave/training_data_after_cluster.csv', index=False)
