...
for i in range(1,10):
    ...
    training_data_cluster=k_model.fit_predict(x[["M_HADDR"]])
...
cluster_prediction=k_model.predict(x_prediction[["M_HADDR"]])
...
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/basic_transfer_single_master_single_slave/prediction_data_after_cluster.csv', index=False)
training_data_after_cluster.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/basic_transfer_single_master_single_slave/training_data_after_cluster.csv', index=False)
