...
training_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/default_master_and_slave/training_data_after_cluster.csv',sep=',')
prediction_file=pd.read_csv('C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/default_master_and_slave/prediction_data_after_cluster.csv',sep=',')
...
ideal_ccp_alpha=0.0674271 #from graph
...
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/default_master_and_slave/cluster0_predicted_data.csv', index=False)
...
x_prediction.drop(columns=["Coverage"],axis=1, inplace=True)
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/default_master_and_slave/cluster1_predicted_data.csv', index=False)
...
x_prediction.drop(columns=["Coverage"],axis=1, inplace=True)
#%% Export Data to CSV
x_prediction.to_csv(path_or_buf='C:/Users/Dell/Documents/Bachelor Thesis/UVM_FOR_AHB/csv_files/from_python/predicted/cluster/default_master_and_slave/cluster2_predicted_data.csv', index=False)
...
#cluster 3 has no predicted data
